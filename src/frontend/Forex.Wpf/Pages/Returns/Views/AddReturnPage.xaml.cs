...
public partial class AddReturnPage : Page
{
    ...
    private readonly AddReturnPageViewModel vm;
    ...
    {
        InitializeComponent();
        vm = App.AppHost!.Services.GetRequiredService<AddReturnPageViewModel>();
        DataContext = vm;
    ...
    private void ClosePopup_MouseDown(object sender, MouseButtonEventArgs e)
    {
        ...
        if (e.OriginalSource == sender && DataContext is AddReturnPageViewModel viewModel && viewModel.IsPopupOpen)
        {
